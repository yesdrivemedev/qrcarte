 ...
 */
final class Version20230226145533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE proprietaire CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE proprietaire CHANGE user_id user_id INT NOT NULL');
